...
dataframe <- read.csv("sample data 2.csv")
df <- dataframe

relationships <- relationship_perline(dataframe)
real <- relationships

newdf <- gender_perrelationship(dataframe, relationships)

tryagain <- gender_perrelationship(df, real)
